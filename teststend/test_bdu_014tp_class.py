...
class TestBDU014TP:
    ...
    def test_20(self) -> bool:
        ...
        sleep(1)
        if self.di_read.subtest_1di(test_num=2, subtest_num=2.0, err_code=21, di_a='in_a1'):
            return True
        return False
    ...
    def test_22(self) -> bool:
        ...
        sleep(1)
        if self.di_read.subtest_1di(test_num=2, subtest_num=2.2, err_code=27, di_a='in_a1'):
            return True
        return False
    ...
    def test_31(self) -> bool:
        ...
        sleep(1)
        if self.di_read.subtest_1di(test_num=3, subtest_num=3.1, err_code=28, position=True, di_a='in_a1'):
            return True
        return False
    ...
    def test_40(self) -> bool:
        ...
        sleep(1)
        if self.di_read.subtest_1di(test_num=4, subtest_num=4.0, err_code=29, di_a='in_a1'):
            self.ctrl_kl.ctrl_relay('KL12', False)
    ...
    def test_51(self) -> bool:
        ...
        sleep(2)
        if self.di_read.subtest_1di(test_num=5, subtest_num=5.1, err_code=3, di_a='in_a1'):
            self.ctrl_kl.ctrl_relay('KL12', False)
            self.ctrl_kl.ctrl_relay('KL1', False)
    ...
    def test_61(self) -> bool:
        ...
        self.logger.debug(f'отключение KL12')
        sleep(1)
        if self.di_read.subtest_1di(test_num=6, subtest_num=6.1, err_code=4, position=False, di_a='in_a1'):
            return True
        return False
