...
class TestBDUDR01:
    ...
    def st_test_1(self) -> bool:
        ...
        :rtype bool:
        """
        if self.subtest.subtest_4di(test_num=1, subtest_num=1.0, err_code_a=216, err_code_b=217, err_code_c=218,
                                    err_code_d=219, position_a=False, position_b=False, position_c=False,
                                    position_d=False, inp_a='in_a1', inp_b='in_a2', inp_c='in_a3', inp_d='in_a4'):
            return True
        return False
    ...
    def st_test_20(self) -> bool:
        ...
        if self.subtest.subtest_4di(test_num=2, subtest_num=2.0, err_code_a=220, err_code_b=221, err_code_c=222,
    ...
    def st_test_21(self) -> bool:
        ...
        if self.subtest.subtest_a(test_num=2, subtest_num=2.1, resistance=10,
                                  ...
                                  inp_a='in_a1', inp_b='in_a2', inp_c='in_a3', inp_d='in_a4'):
    ...
    def st_test_23(self) -> bool:
        ...
        sleep(1)
        if self.subtest.subtest_4di(test_num=2, subtest_num=2.3, err_code_a=232, err_code_b=233, err_code_c=234,
    ...
    def st_test_32(self) -> bool:
        ...
        sleep(1)
        if self.subtest.subtest_4di(test_num=3, subtest_num=3.2, err_code_a=236, err_code_b=237, err_code_c=238,
    ...
    def st_test_42(self) -> bool:
        ...
        sleep(1)
        if self.subtest.subtest_4di(test_num=4, subtest_num=4.3, err_code_a=240, err_code_b=241, err_code_c=242,
    ...
    def st_test_52(self) -> bool:
        ...
        self.logger.debug("отключен KL12")
        sleep(1)
        if self.subtest.subtest_4di(test_num=5, subtest_num=5.2, err_code_a=244, err_code_b=245, err_code_c=246,
    ...
    def st_test_60(self) -> bool:
        ...
        sleep(1)
        if self.subtest.subtest_4di(test_num=6, subtest_num=6.0, err_code_a=248, err_code_b=249, err_code_c=250,
    ...
    def st_test_63(self) -> bool:
        ...
        self.logger.debug("отключен KL12")
        sleep(1)
        if self.subtest.subtest_4di(test_num=6, subtest_num=6.3, err_code_a=260, err_code_b=261, err_code_c=262,
    ...
    def st_test_72(self) -> bool:
        ...
        self.resist.resist_10_to_110_ohm()
        sleep(1)
        if self.subtest.subtest_4di(test_num=7, subtest_num=7.2, err_code_a=264, err_code_b=265, err_code_c=266,
    ...
    def st_test_82(self) -> bool:
        ...
        self.logger.debug("включен KL11")
        sleep(1)
        if self.subtest.subtest_4di(test_num=8, subtest_num=8.2,
    ...
    def st_test_92(self):
        ...
        self.logger.debug("отключен KL12")
        sleep(1)
        if self.subtest.subtest_4di(test_num=9, subtest_num=9.2,
