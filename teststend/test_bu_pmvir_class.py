...
class TestBUPMVIR:
    ...
    def __init__(self):
        ...
        logging.basicConfig(filename="C:\Stend\project_class\log\TestBUPMVIR.log",
                            filemode="w",
                            level=logging.DEBUG,
                            encoding="utf-8",
    ...
    def st_test_10(self) -> bool:
        ...
        :return: bool
        """
        if self.di_read.subtest_1di(test_num=1, subtest_num=1.0, err_code=47):
            pass
        else:
            return False
    ...
    def st_test_11(self) -> bool:
        ...
        if self.di_read.subtest_1di(test_num=1, subtest_num=1.1, err_code=90, position=False):
            return True
        return False
    ...
    def st_test_20(self) -> bool:
        ...
        if self.subtest.subtest_a_bupmvir(test_num=2, subtest_num=2.0):
            ...
            sleep(2)
            if self.di_read.subtest_1di(test_num=2, subtest_num=2.1, err_code=92, position=False):
                return True
        return False
    ...
    def st_test_30(self) -> bool:
        ...
        sleep(2)
        if self.di_read.subtest_1di(test_num=3, subtest_num=3.0, err_code=93, position=False):
    ...
    def st_test_40(self) -> bool:
        ...
        if self.subtest.subtest_a_bupmvir(test_num=4, subtest_num=4.0):
            ...
            sleep(2)
            if self.di_read.subtest_1di(test_num=4, subtest_num=4.1, err_code=94, position=False):
                self.ctrl_kl.ctrl_relay('KL12', False)
                self.logger.debug("отключение KL12")
                return True
        return False
    ...
    def st_test_50(self) -> bool:
        ...
        if self.subtest.subtest_a_bupmvir(test_num=5, subtest_num=5.0):
            ...
            sleep(1)
            if self.di_read.subtest_1di(test_num=5, subtest_num=5.1, err_code=95, position=False):
                self.ctrl_kl.ctrl_relay('KL12', False)
    ...
    def st_test_60(self) -> bool:
        ...
        if self.subtest.subtest_a_bupmvir(test_num=6, subtest_num=6.0):
            ...
            self.logger.debug("отключение KL12")
            sleep(1)
            if self.di_read.subtest_1di(test_num=6, subtest_num=6.1, err_code=96, position=False):
                return True
        return False
    ...
    def st_test_70(self) -> bool:
        ...
        if self.subtest.subtest_a_bupmvir(test_num=7, subtest_num=7.0):
            ...
            sleep(6)
            if self.di_read.subtest_1di(test_num=7, subtest_num=7.1, err_code=97, position=False):
                self.ctrl_kl.ctrl_relay('KL30', False)
                self.logger.debug("отключение KL30")
                sleep(6)
                if self.di_read.subtest_1di(test_num=7, subtest_num=7.2, err_code=98, position=True):
                    return True
        return False
